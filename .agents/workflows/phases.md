# TS Screen — Backlog phase 0–7

Làm phase nào cũng phải chạy đủ **5 cổng** trong [../workflows.md](../workflows.md). File này chỉ mô tả *làm gì* theo domain, không được nhảy thẳng vào code.

Rules: [../rules/](../rules/). Xong việc: ghi [../PROGRESS.md](../PROGRESS.md).
